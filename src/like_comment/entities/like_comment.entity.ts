...
export class LikeComment {
    ...
    @ManyToOne(() => User, (user) => user.likesComments, { onDelete: 'CASCADE', eager: true, nullable: false })
    user: User; 

    @ManyToOne(() => Comment, (comment) => comment.likesComments, { onDelete: 'CASCADE', eager: true, nullable: false })
    comment: Comment; 
